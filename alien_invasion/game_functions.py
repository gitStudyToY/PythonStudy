...
#刷新屏幕函数
def update_screen(ai_settings, screen, ship, alien,bullets,play_button,stats,sb):
...
def update_bullets(bullets,aliens,ai_settings, screen, ship,sb,stats):
	...
	check_bullet_alien_collisions(bullets,ai_settings, screen, ship, aliens,sb,stats)
	
		
def check_bullet_alien_collisions(bullets,ai_settings, screen, ship, aliens,sb,stats):
	""" 响应子弹和外星人的碰撞 """
	#  检查是否有子弹击中了外星人
	#  如果是这样，就删除相应的子弹和外星人
